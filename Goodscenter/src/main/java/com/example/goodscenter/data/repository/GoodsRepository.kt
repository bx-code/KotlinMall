...
import com.example.goodscenter.data.protocal.GetGoodsDetailReq
...
class GoodsRepository @Inject constructor(){
    ...
    fun GoodDetail(goodid : Int): Observable<BaseResp<Goods>>{
        return RetrofitFactory.instance.create(GoodsApi::class.java).getGoodsDetail(GetGoodsDetailReq(goodid))
    }
}