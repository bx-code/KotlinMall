...
class BottomNavBar @JvmOverloads constructor(
    ...
    init {
        ...
        val newhomeItm = BottomNavigationItem(R.drawable.btn_nav_home_press,resources.getString(R.string.nav_bar_home))
                .setInactiveIconResource(R.drawable.btn_nav_home_normal)
                .setActiveColorResource(R.color.common_blue)
                .setInActiveColorResource(R.color.text_normal)
        ...
        mMsgBadge.setShape(ShapeBadgeItem.SHAPE_OVAL) //设置普通圆形
        msgItem.setBadgeItem(mMsgBadge) //设置条目数
